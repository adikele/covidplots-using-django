...
@app.route("/valstreetdesign")
def valstreetdesign():
    return render_template("valstreetdesign.html")

@app.route("/real_valstreetdesign")
def real_valstreetdesign():
    return render_template("real_valstreetdesign.html")
